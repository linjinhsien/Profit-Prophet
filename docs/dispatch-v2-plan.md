...
| Task | 標題 | spec 任務 | 併入 audit 發現 | Contract | Issue |
| --- | --- | --- | --- | --- | --- |
| TASK-002 | 版控衛生修復 | — | F-03, F-04 | ✅ 已產出 | — |
| TASK-003 | 對話基礎層 | T001, T003, T004, T005, T006, T015 | — | ✅ 已產出 | #9 |
| TASK-004 | 測試框架 + CI | T002 | F-07, D-1 | ✅ 已產出 | #10 |
| TASK-005 | US1 語音對話 UI | T007–T012 | C-1（ChatBubble 免責聲明） | ✅ 已產出 | #11 |
| TASK-006 | US3 照護紀錄瀏覽 | T016–T020 | C-1（Dashboard 免責聲明） | ✅ 已產出 | #12 |
| TASK-007 | US2 文字對話 | T013, T014 | — | ✅ 已產出 | #13 |
| TASK-008 | US4 篩選搜尋 | T021–T024 | — | ✅ 已產出 | #14 |
| TASK-009 | Polish + 無障礙 | T025–T029 | B-8（資料刪除能力） | ✅ 已產出 | #15 |
